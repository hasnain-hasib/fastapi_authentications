...
USER_NAME = "Hasnain Hasib"
USER_EMAIL = "hasibjoy332@gmail.com"
USER_PASSWORD = "2325210"
...
def user(test_session):
    ...
    model.password = hash_password(USER_PASSWORD)  # Assuming you have a hashing function
